package git.sigmaclient.ui.notifications;

import git.sigmaclient.SigmaClient;
import git.sigmaclient.managers.NotificationManager;
...
public class Notification
{
    ...
    public enum NotificationType
    {
        ...
        public Color getColor(final int i) {
            return (this == NotificationType.INFO) ? SigmaClient.themeManager.getSecondaryColor(i) : this.color;
        }
    }
}
